...
var description = 'Encrypts a message for a given recipient public key using your secret passphrase.\n\n\tExample: encrypt message bba7e2e6a4639c431b68e31115a71ffefcb4e025a4d1656405dfdcd8384719e0 \'Hello world\'\n';

var processInputs = function processInputs(recipient, message) {
	return function (_ref) {
		var passphrase = _ref.passphrase,
		    data = _ref.data;
		return _cryptography2.default.encryptMessage({
...
var encryptMessage = (0, _helpers.createCommand)({
